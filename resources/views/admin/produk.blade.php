        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin/addProduk">add produk</a></li>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{url('/admin/edit_data_produk/'.$prd->id_produk)}}" class="badge badge-success">edit</a>
                <a href="{{url('/admin/delete_data_produk/'.$prd->id_produk)}}" class="badge badge-danger">delete</a>
              </td>
            </tr>
          </tbody>
          @endforeach
