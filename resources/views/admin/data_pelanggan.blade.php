        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$data->alamat}}</td>
              <td>
                <a href="/admin/edit_data_pelanggan/{{$data->id}}" class="badge badge-success">edit</a>
                <a href="/admin/delete_data_pelanggan/{{$data->user_id}}" class="badge badge-danger">delete</a>
