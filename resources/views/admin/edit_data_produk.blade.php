  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- /.table -->
  <form action="/admin/update_data_produk" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
        <div class="row">
    <!-- left column -->
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <div class="form-group"><label>Keterangan</label>
            ...
            <textarea class="form-control" name="keterangan" type="text" id="seo_keywords" size="30"></textarea>
            @endforeach
          </div>
