            ...
            <div style="margin-right: -15px; margin-left: -15px;">
              <div style="width: 100%; padding-right: 15px; padding-left: 15px;">
                <div style="min-height: .01%; overflow-x: auto;">
                  ...
                  <a class="no-print" href="{{url('/superadmin/acc_pembayaran/'.$dt->id_header_transaksi)}}"><button type='submit' class='btn btn-primary'>Terima</button></a>
                  
                  @elseif($dt['status_pesan'] == 'Transaksi Telah di terima')
                    <a class="no-print" href="{{url('/superadmin/cancel_pembayaran/'.$dt->id_header_transaksi)}}"><button type='submit' class='btn btn-warning'>Cancel</button></a>
                  <br> <br>
                  <form class="no-print" method="post" action="{{url('/superadmin/detail_pesanan/'.$dt['id_header_transaksi'])}}">
                    {{csrf_field()}}
